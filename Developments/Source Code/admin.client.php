...
$querycate2 = "SELECT * FROM clients";
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-6">
                        ...
                        <div class="control-group">
                            <label style='color:black;font-weight:bold;margin-top:20px' for='name'>Lọc theo số điện thoại:</label>
                            <input  type="text" name='myInput3' id="myInput3" class="form-control"  onkeyup="myFunction2()" placeholder="Nhập số điện thoại để tìm kiếm.." style='border: 2px solid #1d2434;'>
                        </div>
                        <div class="row justify-content-center">
                            <button class="btnp" type="button" id="xoa" disabled onclick="location.href = 'admin.client.php'" style="margin-top:20px">Xoá tìm kiếm</button>
                        </div>
                    </div>
                                ...
                                while ($fieldcate2 = mysqli_fetch_array($rscate2)) :
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-style:italic">
                                            <a  href="admin.appointment.php?proid=<?= $fieldcate2[0] ?>">Đặt lịch</a>
                                        </td>
                                        <td style="font-style:italic">
                                            <a  href="admin.order.php?proid=<?= $fieldcate2[0] ?>">Đặt hàng</a>
                                        </td>
                                    </tr>
                                    <?php
                                endwhile;

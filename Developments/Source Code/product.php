...
if (isset($_POST['btndg'])):
    if (!isset($_SESSION["sesAdmin"])):
        ...
        header("location:product.php?id=$proid&msgOK=Cảm ơn bạn đã đánh giá sản phẩm!");
    endif;
endif;
    ...
    if (!isset($_SESSION["sesAdmin"])):
        ...
        if ($countcheckadd > 0):
            ...
            if (isset($_POST['btnadd'])):
                header("location:product.php?id=$proid&msgOK=Đã thêm số lượng sản phẩm vào giỏ hàng!");
            else:
                header("location:cart.php?msgOK=Đã thêm số lượng sản phẩm vào giỏ hàng!");
            endif;
        else:
            ...
            if (isset($_POST['btnadd'])):
                header("location:product.php?id=$proid&msgOK=Đã thêm sản phẩm vào giỏ hàng!");
            else:
                header("location:cart.php?msgOK=Đã thêm sản phẩm vào giỏ hàng!");
            endif;
        endif;
    endif;
endif;

        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
            <div class="navbar-nav ml-auto">
                ...
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle active" data-toggle="dropdown"><?=$user?></a>
                    <div class="dropdown-menu">
                        <a href="profile.php" class="dropdown-item">Thông tin tài khoản</a>
                        <a href="appolist.php" class="dropdown-item">Dịch vụ đã đặt</a>
                        <a href="orderlist.php" class="dropdown-item">Đơn hàng đã đặt</a>
                    </div>
                </div>
                <a href="cart.php" class="nav-item nav-link login" style="border-radius:15px;margin:0 5px 0 5px">Giỏ hàng: <?=$countcartitem2?></a>

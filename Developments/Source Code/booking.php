                                    ...
                                    <div class="control-group">
                                        ...
                                        <select id="service" onchange="check()" name="service" class="form-control" style="border: 2px solid #1d2434;margin-bottom:20px">
                                            ...
                                            while ($fieldservice = mysqli_fetch_array($rsservice)) :
                                                if ($serid == $fieldservice[0]):
                                                    ?>
                                                    <option value="<?= $fieldservice[0] ?>" selected><?= $fieldservice[1] ?>: <?= $fieldservice[3] ?> VNĐ</option>
                                                    <?php
                                                else:
                                                    ?>
                                                    <option value="<?= $fieldservice[0] ?>"><?= $fieldservice[1] ?>: <?= $fieldservice[3] ?> VNĐ</option>
                                                <?php
                                                endif;
                                            endwhile;
                                            ?> 
